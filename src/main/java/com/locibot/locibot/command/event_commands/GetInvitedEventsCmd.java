...
public class GetInvitedEventsCmd extends BaseCmd {
    ...
    public Mono<?> execute(Context context) {
        ...
        EmbedCreateSpec.Builder embedCreateSpec = EmbedCreateSpec.builder()
                ...
                //.footer(EmbedCreateFields.Footer.of("If you need more information about an event, use \"/info groups <groupName>\"", "https://img.icons8.com/cotton/344/info--v3.png"))
                .color(Color.GREEN)
        ...
        return setup(name, status, scheduled, embedCreateSpec).then(context.createFollowupMessage(embedCreateSpec.build(), true));
    }
